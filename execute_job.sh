...
command="$PYTHON abasp_prepadding.py --dataset $dataset --execution_id $execution_id --num_epochs 150 --num_folds 5 --fold_num $fold_num --postprocessing $postprocessing --bidirectional"
