...
from model.model import Seq2SeqEncoderPositional, Seq2SeqAttentionDecoderPositional, Seq2SeqEncoderPositionalResource
from predicter.predicter import batched_beam_decode, batched_beam_decode_optimized
...
#                        dropout)
encoder = Seq2SeqEncoderPositionalResource(num_activities+3, num_resources+3, embed_size, num_hiddens, time_features, num_layers,
                        dropout)
