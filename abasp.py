...
from predicter.predicter import batched_beam_decode, batched_beam_decode_optimized, predict_seq2seq, predict_seq2seq_optimized
...
if "beam" in postprocessing_type:
    ...
    predictions = predict_seq2seq_optimized(net, test_iter, num_steps, device, name, not args.disable_attention, batch_size, postprocessing_strategy=postprocessing_type)
